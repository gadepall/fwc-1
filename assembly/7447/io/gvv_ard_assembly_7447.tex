...
\item Make connections between the 7447 and the arduino according to Table \ref{table:7447_ard}
%
\begin{table}[!h]
\centering
...
\begin{lstlisting}
wget https://raw.githubusercontent.com/gadepall/arduino/master/assembly/7447/io/codes/op_7447.asm
\end{lstlisting}
\item Now generate the numbers 0-9 by modifying the above program.
%
\item Execute the following program after making the connections in Table \ref{table:ip_7447_ard}.  The number 3 will be displayed. What does the program do?
\begin{lstlisting}
wget https://raw.githubusercontent.com/gadepall/arduino/master/assembly/7447/io/codes/ip_7447.asm
\end{lstlisting}
%
\begin{table}[!h]
\centering
