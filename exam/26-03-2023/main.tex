...
\item 
In Fig.   
    \ref{fig:fig23}, a circle touches all the four sides of a quadrilaterals $ABCD$ whose sides are $AB = 6, BC = 9$ and $CD = 8$ cm.  Find the length of side $AD$. 
%
\begin{figure}[h!]
	\centering
