...
\item 
In Fig   \ref{fig:fig1}, PQ is a chord of length $ 8 cm $ of a circle of radius 5 cm and centre O. The tangents at P and Q intersect at point T. Find the length of TP. 
%
\begin{figure}[h!]
	\centering
    \includegraphics[width=0.5\columnwidth]{figs/100.png}
    \caption{}
    \label{fig:fig1}
\end{figure}

\item How many terms are there in A.P. whose first and fifth terms are -14 and 2, respectively and the last term is 62.
