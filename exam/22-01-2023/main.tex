...
& FWC Entrance
	&
			January 22, 2023,  Duration 30 min
...
\item In Fig.    \ref{fig:fig6},  $TA$ is a tangent to the circle from a point $\vec{T}$ and $TBC$ is a secant to the circle. If $AD$ is the bisector of $\angle{CAB} $, prove that $\triangle{ADT} $ is isosceles.
...
\begin{figure}[h!]
    ...
    \label{fig:fig6}
\end{figure}
\item Which term of the A.P. $3, 15, 27, 39, \dots$ will be 132 more than its $54^{th} $ term?
\end{enumerate}
